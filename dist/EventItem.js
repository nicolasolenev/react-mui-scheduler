...
const EventItem = ({ event, rowId, sx, boxSx, elevation, isMonthMode, onClick, onDragStart, }) => (react_1.default.createElement(Paper_1.default, { sx: sx, draggable: true, onClick: onClick, onDragStart: onDragStart, elevation: elevation || 0, key: `item-d-${event?.id}-${rowId}` },
