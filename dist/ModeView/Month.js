...
var MonthModeView = function (_a) {
        ...
        if (rowInd !== -1) {
            ...
            if (dayInd !== -1) {
                ...
                if (((_f = transfer === null || transfer === void 0 ? void 0 : transfer.item) === null || _f === void 0 ? void 0 : _f.day) !== (day === null || day === void 0 ? void 0 : day.day)) {
                    var itemCheck = day.events.findIndex(function (item) { return (item.day === transfer.item.day && item.label === transfer.item.label); });
                    if (itemCheck === -1) {
                        var prevDay = rowsCopy[transfer.rowIndex]
                            .days
                            .find(function (d) { return d.day === transfer.item.day; });
                        var itemIndexToRemove = (_g = prevDay === null || prevDay === void 0 ? void 0 : prevDay.events) === null || _g === void 0 ? void 0 : _g.findIndex(function (i) { return i.id === transfer.item.id; });
                        if (itemIndexToRemove === undefined || itemIndexToRemove === -1) {
                            return;
                        }
                        (_h = prevDay === null || prevDay === void 0 ? void 0 : prevDay.events) === null || _h === void 0 ? void 0 : _h.splice(itemIndexToRemove, 1);
    ...
    var handleCellClick = function (event, row, day) {
        ...
        if (((_a = day === null || day === void 0 ? void 0 : day.events) === null || _a === void 0 ? void 0 : _a.length) === 0 && onCellClick) {
            onCellClick(event, row, day);
        }
    };
    var renderEvents = function (events, rowId) {
        if (events === void 0) { events = []; }
        return events === null || events === void 0 ? void 0 : events.map(function (event) {
            ...
            return (condition &&
                react_1.default.createElement(EventItem_1.default, { isMonthMode: true, event: event, rowId: rowId, elevation: 0, boxSx: { px: 0.5 }, key: "item-d-".concat(event === null || event === void 0 ? void 0 : event.id, "-").concat(rowId), onClick: function (e) { return handleTaskClick(e, event); }, onDragStart: function (e) { return onCellDragStart(e, event, rowId); }, sx: {
                        width: "100%",
                        py: 0,
                        my: .3,
                ...
                return (react_1.default.createElement(material_1.TableRow, { key: "row-".concat(row.id, "-").concat(index) }, (_a = row === null || row === void 0 ? void 0 : row.days) === null || _a === void 0 ? void 0 : _a.map(function (day, indexD) {
                    ...
                    return (react_1.default.createElement(StyledTableCell, { scope: "row", align: "center", component: "th", sx: { px: 0.5, position: "relative" }, key: "day-".concat(day.id), onDragEnd: onCellDragEnd, onDragOver: onCellDragOver, onDragEnter: function (e) { return onCellDragEnter(e, day.id, row.id); }, onClick: function (event) { return handleCellClick(event, row, day); } },
                        react_1.default.createElement(Box_1.default, { sx: { height: "100%", overflowY: "visible" } },
                            ...
                            (((_c = day === null || day === void 0 ? void 0 : day.events) === null || _c === void 0 ? void 0 : _c.length) > 0 && renderEvents(day === null || day === void 0 ? void 0 : day.events, row.id)),
                            legacyStyle && ((_d = day === null || day === void 0 ? void 0 : day.events) === null || _d === void 0 ? void 0 : _d.length) === 0 &&
