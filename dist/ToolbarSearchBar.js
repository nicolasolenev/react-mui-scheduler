...
var ToolbarSearchBar = function (_a) {
    ...
    var handleOnChange = function (event, value) {
        setValue(value);
        if (onInputChange)
            onInputChange("".concat((value === null || value === void 0 ? void 0 : value.groupLabel) || "", " | (").concat((0, date_fns_1.format)(value === null || value === void 0 ? void 0 : value.startDate, "HH:mm"), " - ").concat((value === null || value === void 0 ? void 0 : value.endDate) || "", ")"));
    };
    return (react_1.default.createElement(StyledAutoComplete, { value: value, id: "scheduler-autocomplete", inputValue: inputValue, sx: { mb: 0, display: "inline-flex" }, onChange: handleOnChange, options: events, groupBy: function (option) { return option ? option === null || option === void 0 ? void 0 : option.groupLabel : ""; }, getOptionLabel: function (option) { return (option ?
            "".concat(option.groupLabel || "", " | ").concat(option.startDate, " | (").concat((0, date_fns_1.format)(option.startDate, "HH:mm") || "", " - ").concat((0, date_fns_1.format)(option.endDate, "HH:mm") || "", ")") : ""); }, isOptionEqualToValue: function (option, value) { return option.id === value.id; }, onInputChange: function (event, newInputValue) {
            setInputValue(newInputValue);
            onInputChange(newInputValue);
        }, renderOption: function (props, option) { return (react_1.default.createElement(material_1.Box, __assign({ component: "li", sx: { fontSize: 12 } }, props), "".concat((0, date_fns_1.format)(option === null || option === void 0 ? void 0 : option.startDate, "dd-MMMM-yyyy", { locale: dateFnsLocale }), " (").concat((0, date_fns_1.format)(option === null || option === void 0 ? void 0 : option.startDate, "HH:mm") || "", " - ").concat((0, date_fns_1.format)(option === null || option === void 0 ? void 0 : option.endDate, "HH:mm") || "", ")"))); }, renderInput: function (params) { return (react_1.default.createElement(material_1.TextField, __assign({}, params, { size: "small", label: t("search"), InputProps: __assign({}, params.InputProps) }))); } }));
};
