    ...
    return (react_1.default.createElement(Toolbar_1.default, { variant: "dense", sx: {
        ...
        react_1.default.createElement(LocalizationProvider_1.LocalizationProvider, { adapterLocale: dateFnsLocale, dateAdapter: AdapterDateFns_1.AdapterDateFns },
            react_1.default.createElement(Grid_1.default, { container: true, spacing: 0, alignItems: "center", justifyContent: "flex-end" },
                react_1.default.createElement(Grid_1.default, { item: true, xs: 1, sm: 2, md: 3 }, toolbarProps.showDatePicker && (react_1.default.createElement(Typography_1.default, { component: "div", sx: { display: "flex" } },
                    react_1.default.createElement(Hidden_1.default, { smDown: true },
                        react_1.default.createElement(IconButton_1.default, { sx: { ml: 0, mr: -0.1 }, ...commonIconButtonProps, onClick: () => handleChangeDate(date_fns_1.sub) },
                        ...
                        react_1.default.createElement(IconButton_1.default, { sx: { ml: 0.2 }, ...commonIconButtonProps, onClick: () => handleChangeDate(date_fns_1.add) },
                    ...
                    react_1.default.createElement(Menu_1.default, { id: "date-menu", anchorEl: anchorDateEl, open: openDateSelector, onClose: handleCloseDateSelector, MenuListProps: { "aria-labelledby": "basic-button" } },
                        react_1.default.createElement(StaticDatePicker_1.StaticDatePicker, { displayStaticWrapperAs: "desktop", value: selectedDate, views: isMonthMode
                                ...
                                : [types_1.DateView.DAY, types_1.DateView.MONTH, types_1.DateView.YEAR], slotProps: toolbarProps.showTodayAction
                ...
                react_1.default.createElement(Grid_1.default, { item: true, xs: true, sm: true, md: true, sx: { textAlign: "right" } },
                    react_1.default.createElement(Stack_1.default, { direction: "row", sx: {
                        ...
                        toolbarProps?.showSearchBar && (react_1.default.createElement(ToolbarSearchBar_1.default, { events: events, onInputChange: (value) => {
                        ...
                        react_1.default.createElement(Hidden_1.default, { mdDown: true }, Object.values(toolbarProps.showSwitchModeButtons).some((val) => val) && (react_1.default.createElement(ToggleButtonGroup_1.default, { exclusive: true, value: mode, size: "small", color: "primary", "aria-label": "text button group", sx: { mt: 0.2, mr: 1.3, display: "contents" }, onChange: (e, mode) => {
                                if (null !== mode)
                                    setMode(mode);
                            } }, [
                            toolbarProps.showSwitchModeButtons?.showMonthButton
                                ? { label: t("month"), value: types_1.Mode.MONTH }
                                : null,
                            toolbarProps.showSwitchModeButtons?.showWeekButton
                                ? { label: t("week"), value: types_1.Mode.WEEK }
                                : null,
                            toolbarProps.showSwitchModeButtons?.showDayButton
                                ? { label: t("day"), value: types_1.Mode.DAY }
                                : null,
                            toolbarProps.showSwitchModeButtons?.showTimelineButton
                                ? { label: t("timeline"), value: types_1.Mode.TIMELINE }
                                : null,
                        ]
                            .filter(Boolean)
                            .map((tb) => (react_1.default.createElement(ToggleButton_1.default, { sx: { mt: 0.5 }, key: tb?.value, value: tb?.value }, tb?.label)))))),
                        toolbarProps?.showOptions && (react_1.default.createElement(IconButton_1.default, { sx: { ml: 1 }, onClick: handleOpenMenu, ...commonIconButtonProps },
                ...
                react_1.default.createElement(Grid_1.default, { item: true, xs: 12, sx: {} },
                    ...
                    react_1.default.createElement(Collapse_1.default, { in: alertProps?.open },
                        react_1.default.createElement(Alert_1.default, { color: alertProps?.color, severity: alertProps?.severity, sx: { borderRadius: 0, mb: 0 }, action: alertProps?.showActionButton ? (react_1.default.createElement(IconButton_1.default, { "aria-label": "close", color: "inherit", size: "small", onClick: handleCloseAlert },
